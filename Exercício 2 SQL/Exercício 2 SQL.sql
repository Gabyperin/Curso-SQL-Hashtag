...
SELECT ProductName AS ' Nome do Produto', Weight 'Peso' FROM DimProduct 
...
SELECT ProductKey AS 'ID do Produto', ProductName AS 'Nome do Produto', UnitPrice AS 'Preço do Produto'
FROM DimProduct
