...
-- TODOS OS PRODUTOS ESTÃO CADASTRADOS CORRETAMENTE 
...
-- O NÚMERO DE CLIENTES REDUZIU PARA 18.869 
...
dimCustomer.*/
	...
	SELECT 
		CustomerKey AS "ID Do Clientes", 
		FirstName AS "Primeiro Nome", 
		EmailAddress AS "Endereço de Email", 
		BirthDate AS "Aniversário dos Clientes" 
	FROM 
		DimCustomer
